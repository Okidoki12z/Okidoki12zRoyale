...
public class CupperhoeItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:cupperhoe")
	public static final Item block = null;
	public CupperhoeItem(AlchemaigicaModElements instance) {
		super(instance, 20);
	}
