...
public class AlchemyStoneBrokenItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:alchemy_stone_broken")
	public static final Item block = null;
	public AlchemyStoneBrokenItem(AlchemaigicaModElements instance) {
		super(instance, 3);
	}
