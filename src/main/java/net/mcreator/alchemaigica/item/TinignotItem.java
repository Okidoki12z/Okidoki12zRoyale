...
public class TinignotItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:tinignot")
	public static final Item block = null;
	public TinignotItem(AlchemaigicaModElements instance) {
		super(instance, 33);
	}
