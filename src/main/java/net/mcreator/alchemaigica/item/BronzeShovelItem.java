...
public class BronzeShovelItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:bronze_shovel")
	public static final Item block = null;
	public BronzeShovelItem(AlchemaigicaModElements instance) {
		super(instance, 44);
	}
