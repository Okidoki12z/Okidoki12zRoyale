...
public class PinkCrystalShardItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:pink_crystal_shard")
	public static final Item block = null;
	public PinkCrystalShardItem(AlchemaigicaModElements instance) {
		super(instance, 35);
	}
