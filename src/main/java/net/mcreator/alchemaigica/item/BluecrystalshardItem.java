...
public class BluecrystalshardItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:bluecrystalshard")
	public static final Item block = null;
	public BluecrystalshardItem(AlchemaigicaModElements instance) {
		super(instance, 34);
	}
