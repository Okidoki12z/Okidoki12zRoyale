...
public class AlchemyStoneBroken1Item extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:alchemy_stone_broken_1")
	public static final Item block = null;
	public AlchemyStoneBroken1Item(AlchemaigicaModElements instance) {
		super(instance, 2);
	}
