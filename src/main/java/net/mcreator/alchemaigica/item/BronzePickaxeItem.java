...
public class BronzePickaxeItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:bronze_pickaxe")
	public static final Item block = null;
	public BronzePickaxeItem(AlchemaigicaModElements instance) {
		super(instance, 41);
	}
