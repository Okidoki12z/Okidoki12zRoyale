...
public class CrystalShardItem extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:red_crystal_shard")
	public static final Item block = null;
	public CrystalShardItem(AlchemaigicaModElements instance) {
		super(instance, 29);
	}
