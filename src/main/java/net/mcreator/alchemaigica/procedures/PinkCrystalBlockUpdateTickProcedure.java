...
import net.mcreator.alchemaigica.block.Crystal8Block;
import net.mcreator.alchemaigica.block.Crystal5Block;
import net.mcreator.alchemaigica.block.Crystal2Block;
import net.mcreator.alchemaigica.block.Crystal22Block;
import net.mcreator.alchemaigica.block.Crystal14Block;
import net.mcreator.alchemaigica.block.Crystal11Block;
...
public class PinkCrystalBlockUpdateTickProcedure extends AlchemaigicaModElements.ModElement {
	public PinkCrystalBlockUpdateTickProcedure(AlchemaigicaModElements instance) {
		super(instance, 52);
	}
