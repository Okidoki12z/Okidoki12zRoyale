...
import net.mcreator.alchemaigica.block.CrystalupgraderpinkBlock;
import net.mcreator.alchemaigica.block.CrystalUpgraderBlock;
import net.mcreator.alchemaigica.block.CruystalupgraderredBlock;
...
public class OnButtonClicked3Procedure extends AlchemaigicaModElements.ModElement {
	public OnButtonClicked3Procedure(AlchemaigicaModElements instance) {
		super(instance, 20);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure OnButtonClicked3!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure OnButtonClicked3!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure OnButtonClicked3!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure OnButtonClicked3!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure OnButtonClicked3!");
			return;
		}
		...
		if ((((new Object() {
			...
			if (entity instanceof PlayerEntity) {
				...
				if (_current instanceof Supplier) {
					Object invobj = ((Supplier) _current).get();
					if (invobj instanceof Map) {
						ItemStack _setstack = new ItemStack(MagicStoneItem.block, (int) (1));
			...
			public ItemStack getItemStack(int sltid) {
				...
				&& ((((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).experienceLevel : 0) >= 10) && (((world
			...
			public ItemStack getItemStack(int sltid) {
				...
				&& ((((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).experienceLevel : 0) >= 15) && (((world
						.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z)))
