...
public class Alchemystone3rightclickedinairProcedure extends AlchemaigicaModElements.ModElement {
	public Alchemystone3rightclickedinairProcedure(AlchemaigicaModElements instance) {
		super(instance, 23);
	}
