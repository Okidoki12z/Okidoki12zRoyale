...
import net.mcreator.alchemaigica.block.CrystalBlock;
import net.mcreator.alchemaigica.block.Crystal6Block;
import net.mcreator.alchemaigica.block.Crystal4Block;
import net.mcreator.alchemaigica.block.Crystal1Block;
import net.mcreator.alchemaigica.block.Crystal12Block;
import net.mcreator.alchemaigica.block.Crystal10Block;
...
public class CrystalBlockUpdateTickProcedure extends AlchemaigicaModElements.ModElement {
	public CrystalBlockUpdateTickProcedure(AlchemaigicaModElements instance) {
		super(instance, 31);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure CrystalBlockUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure CrystalBlockUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure CrystalBlockUpdateTick!");
			return;
		}
