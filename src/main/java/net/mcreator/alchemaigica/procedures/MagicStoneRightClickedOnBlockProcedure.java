...
public class MagicStoneRightClickedOnBlockProcedure extends AlchemaigicaModElements.ModElement {
	public MagicStoneRightClickedOnBlockProcedure(AlchemaigicaModElements instance) {
		super(instance, 2);
