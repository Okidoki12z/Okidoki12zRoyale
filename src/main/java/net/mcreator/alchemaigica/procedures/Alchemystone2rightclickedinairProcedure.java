...
public class Alchemystone2rightclickedinairProcedure extends AlchemaigicaModElements.ModElement {
	public Alchemystone2rightclickedinairProcedure(AlchemaigicaModElements instance) {
		super(instance, 22);
	}
