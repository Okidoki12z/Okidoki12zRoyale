...
public class Crystal9Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_9")
	public static final Block block = null;
	public Crystal9Block(AlchemaigicaModElements instance) {
		super(instance, 44);
	}
