...
public class Crystal22Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_22")
	public static final Block block = null;
	public Crystal22Block(AlchemaigicaModElements instance) {
		super(instance, 37);
	}
