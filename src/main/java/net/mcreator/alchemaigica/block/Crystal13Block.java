...
public class Crystal13Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_13")
	public static final Block block = null;
	public Crystal13Block(AlchemaigicaModElements instance) {
		super(instance, 48);
	}
