...
public class Crystal8Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_8")
	public static final Block block = null;
	public Crystal8Block(AlchemaigicaModElements instance) {
		super(instance, 43);
	}
