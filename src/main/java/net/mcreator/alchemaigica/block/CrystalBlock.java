...
public class CrystalBlock extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal")
	public static final Block block = null;
	public CrystalBlock(AlchemaigicaModElements instance) {
		super(instance, 29);
	}
