...
public class Crystal15Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_15")
	public static final Block block = null;
	public Crystal15Block(AlchemaigicaModElements instance) {
		super(instance, 50);
	}
