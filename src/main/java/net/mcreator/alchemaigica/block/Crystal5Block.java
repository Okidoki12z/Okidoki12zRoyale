...
public class Crystal5Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_5")
	public static final Block block = null;
	public Crystal5Block(AlchemaigicaModElements instance) {
		super(instance, 40);
	}
