...
public class TinoreBlock extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:tinore")
	public static final Block block = null;
	public TinoreBlock(AlchemaigicaModElements instance) {
		super(instance, 32);
	}
