...
public class BronzeBlockBlock extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:bronze_block")
	public static final Block block = null;
	public BronzeBlockBlock(AlchemaigicaModElements instance) {
		super(instance, 37);
	}
