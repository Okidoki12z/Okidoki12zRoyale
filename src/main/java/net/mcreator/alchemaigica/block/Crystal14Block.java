...
public class Crystal14Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_14")
	public static final Block block = null;
	public Crystal14Block(AlchemaigicaModElements instance) {
		super(instance, 49);
	}
