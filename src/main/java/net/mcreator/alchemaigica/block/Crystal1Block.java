...
public class Crystal1Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_1")
	public static final Block block = null;
	public Crystal1Block(AlchemaigicaModElements instance) {
		super(instance, 36);
	}
