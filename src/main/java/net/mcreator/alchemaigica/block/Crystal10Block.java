...
public class Crystal10Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_10")
	public static final Block block = null;
	public Crystal10Block(AlchemaigicaModElements instance) {
		super(instance, 45);
	}
