...
public class Crystal3Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_3")
	public static final Block block = null;
	public Crystal3Block(AlchemaigicaModElements instance) {
		super(instance, 38);
	}
