...
public class Crystal7Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_7")
	public static final Block block = null;
	public Crystal7Block(AlchemaigicaModElements instance) {
		super(instance, 42);
	}
