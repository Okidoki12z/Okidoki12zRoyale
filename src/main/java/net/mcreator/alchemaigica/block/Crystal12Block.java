...
public class Crystal12Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_12")
	public static final Block block = null;
	public Crystal12Block(AlchemaigicaModElements instance) {
		super(instance, 47);
	}
