...
public class Crystal2Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_2")
	public static final Block block = null;
	public Crystal2Block(AlchemaigicaModElements instance) {
		super(instance, 33);
	}
