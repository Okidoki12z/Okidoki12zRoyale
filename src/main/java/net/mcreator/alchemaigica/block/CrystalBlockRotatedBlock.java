...
public class CrystalBlockRotatedBlock extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_block_rotated")
	public static final Block block = null;
	public CrystalBlockRotatedBlock(AlchemaigicaModElements instance) {
		super(instance, 32);
	}
