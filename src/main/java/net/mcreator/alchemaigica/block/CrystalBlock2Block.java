...
import net.mcreator.alchemaigica.procedures.PinkCrystalBlockUpdateTickProcedure;
import net.mcreator.alchemaigica.itemgroup.WTFItemGroup;
import net.mcreator.alchemaigica.item.PinkCrystalShardItem;
...
public class CrystalBlock2Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_block_2")
	public static final Block block = null;
	public CrystalBlock2Block(AlchemaigicaModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystal_block_2");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				PinkCrystalBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("crystal_block_2", "crystal_block_2", blockAt -> {
