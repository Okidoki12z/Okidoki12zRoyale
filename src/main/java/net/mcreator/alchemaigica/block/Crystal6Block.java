...
public class Crystal6Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_6")
	public static final Block block = null;
	public Crystal6Block(AlchemaigicaModElements instance) {
		super(instance, 41);
	}
