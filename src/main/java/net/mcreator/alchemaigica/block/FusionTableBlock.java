...
import net.mcreator.alchemaigica.gui.FusionTableGuiGui;
...
public class FusionTableBlock extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:fusion_table")
	public static final Block block = null;
	public FusionTableBlock(AlchemaigicaModElements instance) {
		super(instance, 9);
	}
