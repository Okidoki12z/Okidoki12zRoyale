...
public class CrystalUpgraderBlock extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_upgrader_blue")
	public static final Block block = null;
	public CrystalUpgraderBlock(AlchemaigicaModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystal_upgrader_blue");
		}
