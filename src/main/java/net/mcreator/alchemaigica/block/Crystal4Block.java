...
public class Crystal4Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_4")
	public static final Block block = null;
	public Crystal4Block(AlchemaigicaModElements instance) {
		super(instance, 39);
	}
