...
public class Crystal11Block extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:crystal_11")
	public static final Block block = null;
	public Crystal11Block(AlchemaigicaModElements instance) {
		super(instance, 46);
	}
