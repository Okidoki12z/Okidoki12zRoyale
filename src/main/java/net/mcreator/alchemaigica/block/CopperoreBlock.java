...
public class CopperoreBlock extends AlchemaigicaModElements.ModElement {
	@ObjectHolder("alchemaigica:copperore")
	public static final Block block = null;
	public CopperoreBlock(AlchemaigicaModElements instance) {
		super(instance, 2);
	}
