...
public class Crystal5Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_5")
	public static final Block block = null;
	public Crystal5Block(QuarrycraftModElements instance) {
		super(instance, 40);
	}
