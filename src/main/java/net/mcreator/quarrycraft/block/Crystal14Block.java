...
public class Crystal14Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_14")
	public static final Block block = null;
	public Crystal14Block(QuarrycraftModElements instance) {
		super(instance, 49);
	}
