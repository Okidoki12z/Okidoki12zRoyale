...
public class Crystal10Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_10")
	public static final Block block = null;
	public Crystal10Block(QuarrycraftModElements instance) {
		super(instance, 45);
	}
