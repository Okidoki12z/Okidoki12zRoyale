...
public class Crystal11Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_11")
	public static final Block block = null;
	public Crystal11Block(QuarrycraftModElements instance) {
		super(instance, 46);
	}
