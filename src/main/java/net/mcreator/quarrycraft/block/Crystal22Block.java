...
public class Crystal22Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_22")
	public static final Block block = null;
	public Crystal22Block(QuarrycraftModElements instance) {
		super(instance, 37);
	}
