...
public class Crystal9Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_9")
	public static final Block block = null;
	public Crystal9Block(QuarrycraftModElements instance) {
		super(instance, 44);
	}
