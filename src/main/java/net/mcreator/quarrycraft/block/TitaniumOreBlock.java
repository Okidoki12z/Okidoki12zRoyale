...
import net.mcreator.quarrycraft.item.TitaniumIngotItem;
...
public class TitaniumOreBlock extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:titanium_ore")
	public static final Block block = null;
	public TitaniumOreBlock(QuarrycraftModElements instance) {
		super(instance, 61);
	}
