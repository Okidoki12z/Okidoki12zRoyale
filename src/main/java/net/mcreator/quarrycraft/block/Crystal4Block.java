...
public class Crystal4Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_4")
	public static final Block block = null;
	public Crystal4Block(QuarrycraftModElements instance) {
		super(instance, 39);
	}
