...
public class Crystal1Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_1")
	public static final Block block = null;
	public Crystal1Block(QuarrycraftModElements instance) {
		super(instance, 36);
	}
