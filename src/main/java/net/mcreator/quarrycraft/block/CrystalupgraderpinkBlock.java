...
public class CrystalupgraderpinkBlock extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystalupgraderpink")
	public static final Block block = null;
	public CrystalupgraderpinkBlock(QuarrycraftModElements instance) {
		super(instance, 11);
	}
