...
public class Crystal12Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_12")
	public static final Block block = null;
	public Crystal12Block(QuarrycraftModElements instance) {
		super(instance, 47);
	}
