...
public class Crystal15Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_15")
	public static final Block block = null;
	public Crystal15Block(QuarrycraftModElements instance) {
		super(instance, 50);
	}
