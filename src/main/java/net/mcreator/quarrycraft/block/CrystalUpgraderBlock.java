...
public class CrystalUpgraderBlock extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_upgrader_blue")
	public static final Block block = null;
	public CrystalUpgraderBlock(QuarrycraftModElements instance) {
		super(instance, 10);
	}
