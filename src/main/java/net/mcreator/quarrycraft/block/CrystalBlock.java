...
public class CrystalBlock extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal")
	public static final Block block = null;
	public CrystalBlock(QuarrycraftModElements instance) {
		super(instance, 29);
	}
