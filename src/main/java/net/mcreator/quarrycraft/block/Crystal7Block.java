...
public class Crystal7Block extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:crystal_7")
	public static final Block block = null;
	public Crystal7Block(QuarrycraftModElements instance) {
		super(instance, 42);
	}
