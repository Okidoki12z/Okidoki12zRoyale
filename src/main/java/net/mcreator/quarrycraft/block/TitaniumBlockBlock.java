...
public class TitaniumBlockBlock extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:titanium_block")
	public static final Block block = null;
	public TitaniumBlockBlock(QuarrycraftModElements instance) {
		super(instance, 62);
	}
