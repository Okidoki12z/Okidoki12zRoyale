...
public class TitaniumHoeItem extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:titanium_hoe")
	public static final Item block = null;
	public TitaniumHoeItem(QuarrycraftModElements instance) {
		super(instance, 70);
	}
