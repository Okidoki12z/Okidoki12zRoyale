...
public class BronzePickaxeItem extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:bronze_pickaxe")
	public static final Item block = null;
	public BronzePickaxeItem(QuarrycraftModElements instance) {
		super(instance, 41);
	}
