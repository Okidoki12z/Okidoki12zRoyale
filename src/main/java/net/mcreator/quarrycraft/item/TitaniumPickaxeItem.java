...
public class TitaniumPickaxeItem extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:titanium_pickaxe")
	public static final Item block = null;
	public TitaniumPickaxeItem(QuarrycraftModElements instance) {
		super(instance, 66);
	}
