...
public class TitaniumAxeItem extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:titanium_axe")
	public static final Item block = null;
	public TitaniumAxeItem(QuarrycraftModElements instance) {
		super(instance, 67);
	}
