...
public class TitaniumShovelItem extends QuarrycraftModElements.ModElement {
	@ObjectHolder("quarrycraft:titanium_shovel")
	public static final Item block = null;
	public TitaniumShovelItem(QuarrycraftModElements instance) {
		super(instance, 69);
	}
