...
package net.mcreator.quarrycraft.gui;
...
import net.mcreator.quarrycraft.procedures.OnButtonClickedProcedure;
import net.mcreator.quarrycraft.QuarrycraftModElements;
import net.mcreator.quarrycraft.QuarrycraftMod;
...
public class FusionTableGuiGui extends QuarrycraftModElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				QuarrycraftMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
