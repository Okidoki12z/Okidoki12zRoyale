...
public class CrystalBlockUpdateTickProcedure extends QuarrycraftModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((!((((Entity) world
			...
			world.setBlockState(new BlockPos((int) (x + 1), (int) y, (int) z), Crystal12Item.block.getDefaultState(), 3);
			...
			world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), CrystalItem.block.getDefaultState(), 3);
		} else if (((!((((Entity) world
				.getEntitiesWithinAABB(ServerPlayerEntity.class,
						new AxisAlignedBB(x - (50 / 2d), y - (50 / 2d), z - (50 / 2d), x + (50 / 2d), y + (50 / 2d), z + (50 / 2d)), null)
				.stream().sorted(new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) (z + 1)), Crystal4Block.block.getDefaultState(), 3);
				...
				&& ((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == Blocks.AIR.getDefaultState().getBlock()))) {
			world.setBlockState(new BlockPos((int) (x - 1), (int) y, (int) z), Crystal10Item.block.getDefaultState(), 3);
		} else if (((!((((Entity) world
				.getEntitiesWithinAABB(ServerPlayerEntity.class,
						new AxisAlignedBB(x - (50 / 2d), y - (50 / 2d), z - (50 / 2d), x + (50 / 2d), y + (50 / 2d), z + (50 / 2d)), null)
				.stream().sorted(new Object() {
